...
func TestErrorVideEtudiant(t *testing.T) {
	if _, err := sousEnsembles(nil); err != errPasEnsemble {
		t.Fail()
	}
}

func TestErrorPasEnsembleEtudiant(t *testing.T) {
	if _, err := sousEnsembles([]int{1, 2, 1}); err != errPasEnsemble {
		t.Fail()
	}
}

func TestErrorPasEnsemble2Etudiant(t *testing.T) {
	if _, err := sousEnsembles([]int{1, 2, 3, 2}); err != errPasEnsemble {
		t.Fail()
	}
}

func TestSingletonEtudiant(t *testing.T) {
