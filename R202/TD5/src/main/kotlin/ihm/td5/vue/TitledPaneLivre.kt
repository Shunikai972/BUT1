...
open class TitledPaneLivre(str: String): TitledPane() {
   ...
   var numero: Int
    ...
    open fun update(numero: Int, livre: Livre?) {
        ...
        // mise en place de la ComboBox pour les catégories et ajout de la catégorie du livre sélectionné
        // quand on affiche l'information dédiée à un livre la comboBoxCategorie ne contient que la catégorie du livre

        this.comboBoxCategorie.items.clear()
        this.comboBoxCategorie.items.add(livre?.categorie)
        this.comboBoxCategorie.selectionModel.select(0)
        this.grille.add(comboBoxCategorie, 1, 2)
        
        // mise en place de la ComboBox pour les auteurs et ajout de l'auteur du livre sélectionné
        // quand on affiche l'information dédiée à un livre la comboBoxAuteur ne contient que l'auteur du livre
